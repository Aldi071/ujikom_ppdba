...
@section('content')
    ...
    <section class="section">
        <div class="container">
            <!-- Hapus alert gelombang kosong jika ada -->

            <!-- Form Container dengan kondisi blur -->
            <div class="form-container-wrapper @if(!$gelombangAktif || auth()->guest()) blurred @endif">

                <!-- Overlay untuk gelombang belum aktif -->
                @if(!$gelombangAktif)
                    <div class="form-overlay">
                        <div class="overlay-content">
                            <div style="text-align: center; margin-bottom: 20px;">
                                <i class="fas fa-calendar-times" style="font-size: 3rem; color: #ef4444;"></i>
                            </div>
                            <h3 style="color: #ef4444; margin-bottom: 15px;">Pendaftaran Belum Dibuka</h3>
                            <p style="color: var(--text-light); margin-bottom: 25px;">
                                Gelombang pendaftaran belum aktif. Silakan tunggu pengumuman resmi dari sekolah.
                            </p>
                            <a href="/informasi" class="btn btn-primary" style="width: 100%;">
                                <i class="fas fa-info-circle"></i> Lihat Informasi Pendaftaran
                            </a>
                        </div>
                    </div>
                @endif

                <!-- Overlay untuk login required -->
                @if(auth()->guest() && $gelombangAktif)
                    <div class="form-overlay">
                        <div class="overlay-content">
                            <div style="text-align: center; margin-bottom: 20px;">
                            ...
                            <p style="text-align: center; margin-top: 15px; color: var(--text-light);">
                                ...
                                <a href="/" onclick="openModal('registerModal')"
                                    style="color: var(--primary-blue); font-weight: 600">Daftar di sini</a>
                            </p>
                        </div>
                    </div>
                @endif
                        ...
                        <div class="section-indicators">
                            @foreach(['Data Diri', 'Sekolah Asal', 'Orang Tua', 'Berkas', 'Jurusan'] as $index => $label)
                                <div class="section-indicator {{ $index === 0 ? 'active' : '' }}"
                                    data-section="{{ $index + 1 }}" onclick="singleFormNavigator.goToSection({{ $index + 1 }})">
                        ...
                        <div class="form-section active" id="section1">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nik" name="nik" required placeholder="16 digit NIK"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nisn" name="nisn" required placeholder="10 digit NISN"
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="wilayah_id" name="wilayah_id" required disabled>
                        ...
                        <div class="form-section" id="section2">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="schoolNpsn" name="schoolNpsn" required placeholder="8 digit NPSN"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="averageGrade" name="averageGrade" required placeholder="0-100"
                        ...
                        <div class="form-section" id="section3">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="waliName" name="waliName"
                                        placeholder="Opsional jika sama dengan orang tua">
                                </div>
                            ...
                            <div class="form-group full-width">
                                ...
                                <textarea id="parentAddress" name="parentAddress" rows="3" required
                                    placeholder="Jika sama dengan alamat siswa, tulis 'Sama dengan alamat siswa'"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-section" id="section4">
                            ...
                            <div class="form-grid">
                                <div class="form-group full-width">
                                    ...
                                    <div class="file-upload-area" onclick="document.getElementById('kkFile').click()">
                                        <i class="fas fa-cloud-upload-alt"
                                            style="font-size: 2rem; color: var(--primary-blue); margin-bottom: 10px;"></i>
                                        <p>Klik untuk upload KK</p>
                                        <small style="color: var(--text-light);">Format: PDF/JPG/PNG, Max: 2MB</small>
                                    </div>
                                    <input type="file" id="kkFile" name="kkFile" accept=".pdf,.jpg,.jpeg,.png" required
                                        style="display: none;"
                                        onchange="singleFormNavigator.handleFileUpload(this, 'kkPreview')">
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <input type="file" id="aktaFile" name="aktaFile" accept=".pdf,.jpg,.jpeg,.png" required
                                        style="display: none;"
                                        onchange="singleFormNavigator.handleFileUpload(this, 'aktaPreview')">
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <input type="file" id="ijazahFile" name="ijazahFile" accept=".pdf,.jpg,.jpeg,.png"
                                        required style="display: none;"
                                        onchange="singleFormNavigator.handleFileUpload(this, 'ijazahPreview')">
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <input type="file" id="kipFile" name="kipFile" accept=".pdf,.jpg,.jpeg,.png"
                                        style="display: none;"
                                        onchange="singleFormNavigator.handleFileUpload(this, 'kipPreview')">
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <input type="file" id="kksFile" name="kksFile" accept=".pdf,.jpg,.jpeg,.png"
                                        style="display: none;"
                                        onchange="singleFormNavigator.handleFileUpload(this, 'kksPreview')">
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <input type="file" id="raporFile" name="raporFile" accept=".pdf,.jpg,.jpeg,.png"
                                        required style="display: none;"
                                        onchange="singleFormNavigator.handleFileUpload(this, 'raporPreview')">
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <div class="file-upload-area" onclick="document.getElementById('photoFile').click()">
                                        ...
                                        <small style="color: var(--text-light);">Format: JPG/PNG, Max: 1MB, Background
                                            merah/blue</small>
                                    </div>
                                    <input type="file" id="photoFile" name="photoFile" accept=".jpg,.jpeg,.png" required
                                        style="display: none;"
                                        onchange="singleFormNavigator.handleFileUpload(this, 'photoPreview')">
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <input type="file" id="certificateFile" name="certificateFile"
                                        ...
                                        onchange="singleFormNavigator.handleFileUpload(this, 'certificatePreview')">
                        ...
                        <div class="form-section" id="submitSection">
                            <div class="agreement-section">
                                <label class="agreement-checkbox">
                                    ...
                                    Saya menyatakan bahwa semua data yang saya isi adalah benar dan dapat
                                    dipertanggungjawabkan.
                                </label>
                            </div>

                            <div class="submit-actions">
                                <button type="button" onclick="singleFormNavigator.previousSection()"
                                    class="btn btn-secondary">
                                    <i class="fas fa-arrow-left"></i> Kembali ke Data Jurusan
                                </button>
                                <button type="button" onclick="singleFormNavigator.submitForm()"
    ...
    <style>
        /* PERBAIKAN: Efek blur untuk kedua kondisi */
        ...
        /* Wrapper untuk form dan overlay */
        .form-container-wrapper {
            position: relative;
            border-radius: 15px;
        }

        .form-container-wrapper.blurred .form-container {
            filter: blur(5px);
            pointer-events: none;
        }

        /* Overlay yang sama untuk kedua kondisi */
        .form-overlay {
            position: absolute;
            top: 0;
            left: 0;
    ...
    <script>
        class SingleFormNavigator {
            constructor() {
                ...
                this.isLocked = {{ !$gelombangAktif || auth()->guest() ? 'true' : 'false' }};
                this.init();
            }
            ...
            setupEventListeners() {
                ...
                // Setup wilayah dropdown events
                this.setupWilayahDropdowns();
            ...
            validateSection(sectionNumber) {
                ...
                requiredFields.forEach(field => {
                    ...
                    if (field.type === 'file') {
                        ...
                        if (!isOptional && !field.files.length) {
                            isValid = false;
                            this.highlightError(field.closest('.file-upload-area') || field);
                            return;
                        } else {
                            this.removeErrorHighlight(field.closest('.file-upload-area') || field);
                        }
                    }
            ...
            nextSection() {
                if (this.isLocked) {
                    if ({{ !$gelombangAktif ? 'true' : 'false' }}) {
                        this.showNotification('Pendaftaran sedang ditutup. Silakan tunggu gelombang pendaftaran dibuka.', 'error');
                    } else {
                        this.showNotification('Silakan login terlebih dahulu untuk mengakses form pendaftaran.', 'error');
                    }
                    return;
                }
            ...
            highlightError(field) {
                if (field.classList && field.classList.contains('file-upload-area')) {
            ...
            saveToLocalStorage() {
                try {
                    ...
                    localStorage.setItem('pendaftaranUser', '{{ auth()->user()->email ?? "" }}');
                } catch (e) {
            ...
            loadFromLocalStorage() {
                try {
                    ...
                    const savedUser = localStorage.getItem('pendaftaranUser');

                    if (savedData && savedUser === currentUser) {
            ...
            clearLocalStorage() {
                ...
                localStorage.removeItem('pendaftaranUser');
            }
            ...
            setupWilayahDropdowns() {
                ...
                const kelurahanSelect = document.getElementById('wilayah_id');
                ...
                provinsiSelect.addEventListener('change', function () {
                    ...
                    self.loadKabupaten(this.value);
                });

                kabupatenSelect.addEventListener('change', function () {
                    console.log('Kabupaten changed:', this.value);
                    self.loadKecamatan(provinsiSelect.value, this.value);
                });

                kecamatanSelect.addEventListener('change', function () {
                    console.log('Kecamatan changed:', this.value);
                    self.loadKelurahan(provinsiSelect.value, kabupatenSelect.value, this.value);
                });

                // Ketika kelurahan dipilih, gunakan kecamatan sebagai acuan untuk mendapatkan koordinat
                kelurahanSelect.addEventListener('change', async function() {
                    try {
                        const selected = this.selectedOptions[0];
                        const latInput = document.getElementById('latitude');
                        const lngInput = document.getElementById('longitude');
                        // Ambil kecamatan dari select kecamatan yang tersedia
                        ...
                        // Panggil API server untuk mendapatkan koordinat berdasarkan kecamatan
                        const url = `/pendaftaran/api/koordinat-kecamatan/${encodeURIComponent(provinsi)}/${encodeURIComponent(kabupaten)}/${encodeURIComponent(kecamatan)}`;
                        ...
                        console.error('Error fetching kecamatan coordinates:', err);
                    }
                });
            }
            ...
            async loadProvinsi() {
                try {
                    const response = await fetch('{{ route("pendaftaran.api.provinsi") }}');
                    ...
                    console.log('Provinsi loaded:', provinsi.length);
                } catch (error) {
            ...
            async loadKabupaten(provinsi) {
                const kabupatenSelect = document.getElementById('kabupaten');
                const kecamatanSelect = document.getElementById('kecamatan');
                const kelurahanSelect = document.getElementById('wilayah_id');

                console.log('Loading kabupaten for provinsi:', provinsi);
                ...
                try {
                    const url = `/pendaftaran/api/kabupaten/${encodeURIComponent(provinsi)}`;
                    ...
                    this.showNotification('Gagal memuat data kabupaten: ' + error.message, 'error');
                }
            }

            async loadKecamatan(provinsi, kabupaten) {
                const kecamatanSelect = document.getElementById('kecamatan');
                const kelurahanSelect = document.getElementById('wilayah_id');
                ...
                try {
                    const response = await fetch(`{{ url('/pendaftaran/api/kecamatan') }}/${encodeURIComponent(provinsi)}/${encodeURIComponent(kabupaten)}`);
            ...
            async loadKelurahan(provinsi, kabupaten, kecamatan) {
                const kelurahanSelect = document.getElementById('wilayah_id');
                ...
                try {
                    const response = await fetch(`{{ url('/pendaftaran/api/kelurahan') }}/${encodeURIComponent(provinsi)}/${encodeURIComponent(kabupaten)}/${encodeURIComponent(kecamatan)}`);
                    const kelurahan = await response.json();

                    kelurahanSelect.innerHTML = '<option value="">Pilih Kelurahan/Desa</option>';
                    // Sertakan attribute data-lat dan data-lng sehingga form dapat autofill koordinat
                    kelurahan.forEach(kel => {
                        const latAttr = (kel.lat !== undefined && kel.lat !== null) ? kel.lat : '';
                        const lngAttr = (kel.lng !== undefined && kel.lng !== null) ? kel.lng : '';
                        kelurahanSelect.innerHTML += `<option value="${kel.id}" data-lat="${latAttr}" data-lng="${lngAttr}">${kel.kelurahan}</option>`;
                    });
                ...
                successModal.innerHTML = `
                        ...
                        ">
                            ...
                            <div style="display: flex; gap: 15px; justify-content: center; margin-top: 30px; flex-wrap: wrap;">
                                ...
                                <button onclick="window.open('/kartu-pendaftaran/${registrationNumber}', '_blank')" class="btn btn-success">
